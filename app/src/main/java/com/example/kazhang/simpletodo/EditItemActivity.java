package com.example.kazhang.simpletodo;
...
import static com.example.kazhang.simpletodo.MainActivity.ITEM_POSITION;
import static com.example.kazhang.simpletodo.MainActivity.ITEM_TEXT;

public class EditItemActivity extends AppCompatActivity {

    // track edit text and position of edited item in list
    EditText etItemText;
    int position;
